import 'package:blantt_love_test/Model/user.dart';
...
class HomePage_list extends StatefulWidget {
  const HomePage_list({Key? key}) : super(key: key);

  @override
  _HomePageState createState() => _HomePageState();
}

class _HomePageState extends State<HomePage_list> {
  List<User> _users = [
    User(
        'Elliana Palacios',
        '@elliana',
